...
{
    // HouseCat extends the Cat class and implements the IPetable interface
    public class HouseCat : Cat, IPetable
    {
        ...
        // This method is required since we impelmented the IPetable interface
        public void Pet()
        {
            Console.WriteLine("Cats love to be pet");
        }
