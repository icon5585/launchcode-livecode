...
namespace class_2._10.Controllers
{
    ...
    public class HelloController : Controller
    {
        ...
        {
            // HttpContext.Request provides information on the request that comes from users
        ...
        [HttpGet("welcome/{name?}")] /* == [HttpGet] && [Route("welcome/{name?}")] */
        ...
        {
            // Note: Doing this only for POSTs as query params are only for GETs
