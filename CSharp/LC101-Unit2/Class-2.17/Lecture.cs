 ...
 * 12/1/20
 */
namespace Class_2._17
{
    class Lecture
    {
        static void Main(string[] args)
        {
			// 18.1 Table Relationships

			// 18.1.2 - One to many relationships
			...
			// 18.2 - Has you walking through creating tables/relationships using MySQL Workbench

			// 18.3 - Complex Queries
